...
export default function DiscordLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-800 to-blue-600 relative overflow-hidden flex items-center justify-center">
      ...
      {/* Login Card */}
      <div className="relative z-10 bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-5xl mx-4">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-900 text-white rounded px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <a href="#" className="text-blue-400 text-sm hover:underline inline-block">
          ...
          {/* Right side - QR Code */}
          <div className="flex flex-col items-center text-center px-8 border-l border-gray-700">
            ...
            <p className="text-gray-400 text-sm mb-1">
              Scan this with the <span className="font-semibold">Discord mobile</span>
            </p>
            <p className="text-gray-400 text-sm mb-3">
              <span className="font-semibold">app</span> to log in instantly.
            </p>
